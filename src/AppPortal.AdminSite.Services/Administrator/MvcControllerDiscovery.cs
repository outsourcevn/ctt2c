        ...
        public IEnumerable<MvcControllerInfo> GetControllers()
        {
            ...
            foreach (var actionDescriptors in items)
            {
                                            ...
                                            (a => a.ActionName).Select(g => g.First()))
                {
                    ...
                    // remove action is AllowAnonymousAttribute
                    var isUnProtectedAction = methodInfo.GetCustomAttribute<AllowAnonymousAttribute>() is AllowAnonymousAttribute;
                    if (isUnProtectedAction == true) continue;
