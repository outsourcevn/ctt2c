...
namespace AppPortal.AdminSite.Services.Extensions
{
    public static class ModelMappingExtensions
    {
        ...
        public static HomeNews ModelToEntityHomeNews(this HomeNews model, HomeNews item = null)
        {
            if (item == null) item = new HomeNews();
        ...
        public static NewsPreview ModelToEntityNewsPreview(this NewsPreview model, NewsPreview item = null)
        {
            if (item == null) item = new NewsPreview();
