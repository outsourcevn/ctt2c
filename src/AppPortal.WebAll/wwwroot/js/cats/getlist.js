(function ($) {
    ...
    $(document).ready(function () {
        ...
        var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: `${appConfig.apiHostUrl}/${CATS_API.GET_LIST_CATS}`,
                    dataType: "json",
        ...
        $("#dataGrid").kendoGrid({
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: "<a class='k-button' href='/Categories/Edit?id=#=id#'><i class='fa fa-edit'></i>&nbsp;Sửa</a>" +
...
function onDelete(tag) {
    ...
    kendo.confirm("Xác nhận xóa danh mục này?")
        .done(function () {
            callAjax(
                `${appConfig.apiHostUrl}/${CATS_API.DELETE}`,
                itemId,
